    ...
    <header className="header-top-stripe py-3">
      <div className="container-xxl">
          <div className='row'>
            ...
            <div className='col-6 mb-0'>
              <p className='text-end text-white'>Hotline: <a className='text-white' href='tel:+251 968 983 297'>+251 968 983 297</a></p>
            </div>
          </div>
      </div>
    </header> 
    ...
    <header className='header-upper py-3'>
      <div className='container-xxl'>
        <div className='row align-items-center'>
          <div className='col-2'>
              <h2><Link className='text-white'> EthioTech. </Link></h2>
          </div>
          <div className='col-5'>
            ...
            <div className="col-5">
                <div className="header-upper-links d-flex align-items-center justify-content-between">
                  ...
                  <div>
                    ...
                    <p className='mb-0'> Favorites <br/> Whishlist</p>
                  </Link>
                    </div>
                  <div>
                    <Link className='d-flex align-items-center gap-10 text-white'>
